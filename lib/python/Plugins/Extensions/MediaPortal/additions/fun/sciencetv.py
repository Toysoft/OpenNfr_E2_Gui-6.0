...
class scienceTvGenreScreen(MPScreen):
	...
	def layoutFinished(self):
		self.genreliste.append(('Aktuelles Programm', 1, 'http://www.science-tv.com/c/mid,2668,aktuelles_Programm/?contentpart=prog_video'))
		self.genreliste.append(('Filme auf Abruf', 2, 'http://www.science-tv.com/c/mid,2671,Filme_auf_Abruf/'))
		self.genreliste.append(('TV-Programmvorschau', 3, 'http://www.science-tv.com/c/mid,2670,TV-Programmvorschau/'))
	...
	def keyOK(self):
		...
		if genreID == 1:
			self.session.open(
				GermanyTVPlayer2,
				[(genre, tvLink)],
				'Science-TV - aktuelles Programm'
				)
		else:
			self.session.open(scienceTvListScreen, genreID, tvLink, genre)

class scienceTvListScreen(MPScreen):
	...
	def keyOK(self):
		...
		if self.genreID == 2:
			self.session.open(
				GermanyTVPlayer,
				self.filmliste,
				"http://www.science-tv.com/inc/mod/video/play.php/vid,%s/q,mp4/hq,1/typ,ondemand/file.mp4",
